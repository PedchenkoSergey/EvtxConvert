...
def argument_parser():
    ...
    process_directory_parser_group = process_directory_parser.add_argument_group(
        title="Process directory containing .evtx files")
    process_directory_parser_group.add_argument('--directory', '-d', help="Directory containing .evtx files",
                                                required=True)
